...
Stage 8-T | Tutorial Tooltip & Onboarding System
Status: Stage 8-S complete. Travel scene working.
...
**Resuming from:** Stage 8-S complete — travel scene working
...
**Commit:** `"8T: Tutorial tooltip system — step sequencer, highlight overlay, skip"`
**Next session:** STAGE_08_U.md
...
**File:** `_Docs/Stage_08/STAGE_08_U.md`
